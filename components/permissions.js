...
const PERMISSIONS = {
  ...
  TABLEROS: {
    TODOS: 1,              // Dashboard, Proveedores, Documentos, Reportes, Configuración
    SIN_PROVEEDORES: 2,    // Dashboard, Documentos, Reportes, Configuración
    LIMITADO: 3,           // Documentos, Configuración
  ...
  RUTAS_PERMITIDAS: {
    // Admin (rol 1)
    '1_1': ['dashboard', 'proveedores', 'documentos', 'auditoria', 'reportes', 'conclusion', 'configuracion'], // Admin con todos los tableros
    '1_2': ['dashboard', 'documentos', 'reportes', 'configuracion'],                // Admin sin proveedores
    '1_3': ['documentos', 'configuracion'],                                         // Admin limitado
    '1_4': ['dashboard', 'documentos', 'auditoria', 'reportes', 'conclusion', 'configuracion'],   // Admin configuración específica
    
    // Supervisor (rol 2)
    '2_1': ['dashboard', 'documentos', 'auditoria', 'reportes', 'conclusion', 'configuracion'], // Supervisor con todos
    '2_2': ['dashboard', 'documentos', 'reportes'],                                 // Supervisor sin proveedores
    '2_3': ['documentos'],                                                          // Supervisor limitado
    '2_4': ['dashboard', 'documentos', 'reportes'],                                 // Supervisor configuración específica
    
    // Usuario (rol 3)
    '3_1': ['dashboard', 'proveedores', 'documentos', 'auditoria', 'reportes', 'configuracion'], // Usuario con todos
    '3_2': ['dashboard', 'documentos'],                                             // Usuario sin proveedores
    '3_3': ['documentos', 'conclusion'],                                                          // Usuario limitado
    '3_4': ['documentos'],                                                          // Usuario configuración específica
    
    // Auditor (rol 4)
    '4_1': ['dashboard', 'proveedores', 'documentos', 'auditoria', 'reportes', 'configuracion'], // Auditor con todos los tableros
    '4_2': ['dashboard', 'auditoria', 'reportes', 'configuracion'],                 // Auditor sin proveedores (mismo acceso)
    '4_3': ['documentos', 'auditoria'],                                          // Auditor limitado
  ...
  PAGINA_INICIO: {
    ...
    2: '/documentos',    // Sin proveedores
    3: '/documentos',   // Solo documentos y config
